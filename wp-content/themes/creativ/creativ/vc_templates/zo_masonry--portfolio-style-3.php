...
?>
<div class="zo-masonry-wrapper zo-masonry-style-style-3 <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <?php if( isset($atts['filter']) && $atts['filter'] == 1 ) :?>
        <div class="zo-masonry-filter">
            <ul class="zo-filter-category list-unstyled list-inline">
                <li><a class="active" href="#" data-group="all"><?php echo esc_html_e( 'All', 'creativ' ); ?></a></li>
    ...
    <div class="zo-masonry">
        ...
        while($posts->have_posts()){
            ...
            <div class="zo-masonry-item item-w<?php echo esc_attr($size['width']); ?> item-h<?php echo esc_attr($size['height']); ?>"
                ...
                ?>
                <div class="zo-masonry-inner" style="background-image: url('')">
