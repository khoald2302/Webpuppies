...
?>
<div class="zo-masonry-wrapper zo-masonry-style-style-2 <?php echo esc_attr($atts['template']); ?>" id="<?php echo esc_attr($atts['html_id']); ?>">
        ...
        while ($posts->have_posts()) {
            ...
            <div class="zo-masonry-item item-w<?php echo esc_attr($size['width']); ?> item-h<?php echo esc_attr($size['height']); ?>"
                ...
                <div class="zo-masonry-inner">
                    <div class="zo-masonry-image-wrap" style="background:url(<?php echo esc_url($thumbnail); ?>); ">
                        <div class="zo-masonry-overlay"> </div>
