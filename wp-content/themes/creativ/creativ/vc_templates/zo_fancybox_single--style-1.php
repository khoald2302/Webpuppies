<?php 
    ...
    $zo_title_space = isset($atts['zo_title_space']) ? $atts['zo_title_space'] : '';
?>
<div class="zo-fancyboxes-wraper zo-fancybox-single--style-1 <?php echo esc_attr($zo_fancybox_style); ?> <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <?php if($atts['title']!=''):?>
    ...
    <div class="zo-fancyboxes-body">
        <div class="zo-fancybox-item <?php echo esc_attr($zo_title_space); ?>">
            <?php
