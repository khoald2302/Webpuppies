...
<!--Header top-->
<div id="zo-header-top"  class="zo-header-top-style-6">
    <div class="container-fluid">
        <div id="zo-header-logo" class="col-xs-12 col-sm-3 col-md-4 col-lg-4">
        ...
        <?php if ($smof_data['enable_header_top'] == '1'): ?>
            <?php if ($zo_meta->_zo_header_top_enable == '1' || ($zo_meta->_zo_header == '')): ?>
                <?php if (is_active_sidebar('sidebar-2')) : ?>
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 zo-hiden-mobile"><?php dynamic_sidebar('sidebar-2'); ?></div>
                <?php endif; ?>
                <?php if (is_active_sidebar('sidebar-3')) : ?>
                    <div class="col-xs-12 col-sm-3 col-md-4 col-lg-4 zo-hiden-mobile"><?php dynamic_sidebar('sidebar-3'); ?></div>
                <?php endif; ?>
            <?php endif; ?>
        <?php endif; ?>
    </div>
...
<!--End Header top-->
<div id="zo-header" class="zo-main-header  zo-header-style-6 <?php
