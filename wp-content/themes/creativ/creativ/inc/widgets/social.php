...
class ZO_Social_Widget extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        if (!empty($title))
            ...
            if ($link_facebook != '') {
                echo '<li><a target="_blank" data-rel="tooltip" data-placement="bottom" data-title="Facebook" data-original-title="Facebook" href="'.esc_url($link_facebook).'"><i class="'.$icon_facebook.'"></i></a></li>';
            }

            if ($link_rss != '') {
                echo '<li><a target="_blank" data-rel="tooltip" data-placement="bottom"  data-title="Rss" data-original-title="Rss" href="'.esc_url($link_rss).'"><i class="'.$icon_rss.'"></i></a></li>';
            }

            if ($link_youtube != '') {
                echo '<li><a target="_blank" data-rel="tooltip" data-placement="bottom" data-title="YouTube" data-original-title="YouTube" href="'.esc_url($link_youtube).'"><i class="'.$icon_youtube.'"></i></a></li>';
            }
          if ($link_google != '') {
                echo '<li><a target="_blank" data-rel="tooltip" data-placement="bottom" data-title="Google"  data-original-title="Google" href="'.esc_url($link_google).'"><i class="'.$icon_google.'"></i></a></li>';
           }
            if ($link_twitter != '') {
                echo '<li><a target="_blank" data-rel="tooltip" data-placement="bottom" data-title="Twitter" data-original-title="Twitter" href="'.esc_url($link_twitter).'"><i class="'.$icon_twitter.'"></i></a></li>';
            }

          

            if ($link_skype != '') {
                echo '<li><a target="_blank" data-rel="tooltip" data-placement="bottom" data-title="Skype" data-original-title="Skype" href="'.esc_url($link_skype).'"><i class="'.$icon_skype.'"></i></a></li>';
            }

            if ($link_yahoo != '') {
                echo '<li><a target="_blank" data-rel="tooltip" data-placement="bottom" data-title="Yahoo" data-original-title="Yahoo" href="'.esc_url($link_yahoo).'"><i class="'.$icon_yahoo.'"></i></a></li>';
            }

            if ($link_dribbble != '') {
                echo '<li><a target="_blank" data-rel="tooltip" data-placement="bottom" data-title="Dribbble" data-original-title="Dribbble" href="'.esc_url($link_dribbble).'"><i class="'.$icon_dribbble.'"></i></a></li>';
            }
