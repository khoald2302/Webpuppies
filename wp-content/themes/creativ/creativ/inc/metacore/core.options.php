        ...
        ?>
          <?php 
                ...
                if(!empty($params['follow'])){
                    $data[] = 'data-follow="'.rawurlencode(json_encode($params['follow'][1])).'"';
                    $data[] = 'data-select-value="'.rawurlencode(json_encode($params['follow'][2])).'"';
                }
               
            ?>
        <div class="image-field csfield clearfix" <?php echo implode(' ', $data); ?>>
            <ul>
