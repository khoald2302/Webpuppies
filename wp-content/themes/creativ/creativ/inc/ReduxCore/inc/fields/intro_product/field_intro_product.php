            ...
            <div class="intro-product">
                ...
                <div class="zo-tools">
                    <ul>
                        ...
                        <li><a href="<?php echo esc_url('http://prupalexp.com');?>"><i class="dashicons dashicons-groups"></i><span><?php esc_html_e("Forum Support", 'creativ'); ?></span></a></li>
                        <li><a href="<?php echo esc_url('http://themeforest.net/user/cms-theme/portfolio');?>"><i class="dashicons dashicons-products"></i><span><?php esc_html_e("CMS-Theme", 'creativ'); ?></span></a></li>
                        <li><a href="mailto:wp@zotheme.com"><i class="dashicons dashicons-email"></i><span><?php esc_html_e("Contact Now", 'creativ'); ?></span></a></li>
                    </ul>
                </div>
