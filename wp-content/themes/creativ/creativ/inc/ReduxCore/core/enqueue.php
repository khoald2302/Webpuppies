        ...
        class reduxCoreEnqueue {
            ...
            private function set_localized_data() {
                ...
                if ( isset( $this->parent->args['dev_mode'] ) && $this->parent->args['dev_mode'] == true || $this->parent->args['dev_mode'] == false && isset($this->parent->args['forced_dev_mode_off']) && $this->parent->args['forced_dev_mode_off'] == true ) {
                    ...
                    $base                                = esc_url(admin_url( 'admin-ajax.php' )) . '?action=redux_p&nonce=' . $nonce . '&url=';
                 ...
                 */
                $save_pending = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/save_pending", esc_html__( 'You have changes that are not saved. Would you like to save them now?', 'creativ' ) );
                 ...
                 */
                $reset_all = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/reset", esc_html__( 'Are you sure? Resetting will lose all custom values.', 'creativ' ) );
                 ...
                 */
                $reset_section = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/reset_section", esc_html__( 'Are you sure? Resetting will lose all custom values in this section.', 'creativ' ) );
                 ...
                 */
                $preset_confirm = apply_filters( "redux/{$this->parent->args['opt_name']}/localize/preset", esc_html__( 'Your current options will be replaced with the values of this preset. Would you like to proceed?', 'creativ' ) );
                global $pagenow;
                $this->parent->localize_data['args'] = array(
                    ...
                    'please_wait'           => esc_html__( 'Please Wait', 'creativ' ),
                ...
                $this->parent->localize_data['ajax'] = array(
                    'console' => esc_html__( 'There was an error saving. Here is the result of your action:', 'creativ' ),
                    'alert'   => esc_html__( 'There was a problem with your action. Please try again or reload the page.', 'creativ' ),
                );
